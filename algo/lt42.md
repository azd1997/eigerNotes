...
date: 2019-11-10T22:11:41+08:00
draft: false
categories: ["algo"]
tags: ["leetcode"]
keywords: ["动态规划", "双指针", "栈", "分治"]
---
...
- 动态规划往往可以通过缓存来加速（空间换时间）
- 双指针法
- 将问题分解为子问题之和（分治）
- 基于栈，容易实现“括号匹配”类问题
- go stl 只有 heap/list/ring 三种容器数据结构。但很多其他高级数据结构可以由它们模拟。

## 链接

- Github： <https://github.com/azd1997/Leetcode-training/tree/master/lt42/1.go>
- Leetcode: <https://leetcode-cn.com/problems/trapping-rain-water/solution/jie-yu-shui-shi-xian-yu-zheng-li-by-eiger/>